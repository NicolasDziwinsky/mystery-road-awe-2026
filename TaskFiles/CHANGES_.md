...
3. Fix: Two Changes are necessary
...
4. Change the i inside the loop from var to let inside eventListenerSetup on line 12
...
Bug 3: onChange handleSortChange not defined, sort change does not work - i removed the inline html function call for onChange - i added a event listener for renderEvidenceList for onChange for the filter - i removed renderEvidenceList() from the handleSortChange() function - i added handleSortChange() just before the return statement of getFilteredEvidence
